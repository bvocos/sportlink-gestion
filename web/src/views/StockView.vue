...
<template>
  <section class="page">
    <div class="page-title"><div><h2>Stock</h2><p>Disponibilidad de césped y trazabilidad de los depósitos habilitados.</p></div><button v-if="auth.can('stock','crear')" class="btn" :disabled="!depositosIngreso.length" @click="openIngreso">+ Registrar ingreso</button></div>
